...
namespace TrickleUpPortal.Controllers
{
    public class LiveStock_StepsMaterial_AudioAllocationController : ApiController
    {
        ...
        public HttpResponseMessage PostLiveStock_StepsMaterial_AudioAllocation(LiveStock_StepsMaterial_AudioAllocation liveStock_StepsMaterial_AudioAllocation)
        {
            ...
            int recordCount = db.LiveStock_StepsMaterial_AudioAllocation.Where(a => a.LiveStockStepMaterialId == liveStock_StepsMaterial_AudioAllocation.LiveStockStepMaterialId && a.LangId == liveStock_StepsMaterial_AudioAllocation.LangId && a.Active == true).Count();
            if (recordCount > 0)
            {
